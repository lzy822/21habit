...
public class LoginActivity2 extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.email_up);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.password_up);
        ...
        mLoginFormView = findViewById(R.id.login_form_up);
        mProgressView = findViewById(R.id.login_progress_up);
    }
    ...
    private void sendRequestWithOkHttpForSignUp(final String username, final String password){
        new Thread(new Runnable() {
            @Override
            public void run() {
                try {
